                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {accounts_travel.map((person) => (
                                    <tr key={person.id}>
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{person.tname}</td>
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{person.avdreq}</td>
