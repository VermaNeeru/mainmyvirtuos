...
import { MagnifyingGlassIcon, ChevronDownIcon, PhotoIcon, EyeIcon } from '@heroicons/react/20/solid'
const table_header = [
    { name: 'Name' },
    { name: '' },
];
const tutorials = [
    { id: 1, tname: 'Basic Info & Profile' },
    { id: 2, tname: 'Dashboard & Activity' },
    { id: 3, tname: 'Document , Google App , Gallery' },
    // More people...
]
