...
import { ADD_Leaveusertype_MUTATION, GET_Leaveusertype_BY_ID, UPDATE_Leaveusertype_MUTATION } from '@/graphql/LeaveUserType/queries';
import { useRouter } from 'next/router';
export default function EditLeaveCategory() {
    const router = useRouter();
    const { id } = router.query;
    const [leavetypeId, setLeavetypeId] = useState(parseInt(id, 10));
