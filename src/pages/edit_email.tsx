...
export default function EditEmail() {
    ...
    useEffect(() => {
        if (templateId) {
            ...
            executeQuery({ variables: { id: templateId } });
            console.log(getQueryById);
        }
    }, [templateId,getQueryById,executeQuery]);
    ...
    return (
        <div className=' w-full rounded px-2'>
            {showSuccessMessage && (
                ...
                <Alert message="Template Added Successfully!" alertState={false} onAlertStateChange={function (newState: boolean): void {
