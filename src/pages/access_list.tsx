                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                    {ideas.map((person) => (
                                        <tr key={person.id}>
                                            ...
                                            <td className="whitespace-nowrap px-3 py-2 text-sm text-gray-500">{person.atname}</td>
                                            <td className="whitespace-nowrap px-3 py-2 text-sm text-gray-500">{person.atstatus}</td>
                                                            ...
                                                            <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-1">
                                                                <div className="sm:col-span-2">
                                                                    <div className="space-y-2 px-2 py-2">
                                                                        <div className="pb-4">
                                                                            <div className="grid grid-cols-2 lg:grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
