...
const ideas = [
    { id: 1, tname: 'Basic Info & Profile', tstatus: 'Active' },
    { id: 1, tname: 'Dashboard & Activity', tstatus: 'Active' },
    { id: 1, tname: 'Document , Google App , Gallery', tstatus: 'Active' },
    { id: 1, tname: 'Idea , Issue , FAQ , Imp Links', tstatus: 'Active' },
    // More people...
]
                                                ...
                                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                                                    <div className="space-y-2">
                                                        <div className="border-b border-gray-900/10 pb-4">
                                                            <h2 className="text-lg font-semibold leading-7 text-gray-900">Add Tutorial</h2>
