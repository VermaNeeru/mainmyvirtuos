...
const user_attendance = [
    { id: 1, name: 'Shivam', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', reason: 'Rain' },
    { id: 1, name: 'Gagan', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', reason: 'Rain' },
    { id: 1, name: 'Neeru', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', reason: 'Rain' },
    // More people...
]


export default function CurrentEarlyDeparture() {
                ...
                <div className="flex flex-wrap items-center">
                    <div className="relative w-full max-w-full flex-grow flex-1">
                        <h2 className="text-blueGray-700 text-xl font-semibold">
                            Current Month - Early Departure Report
                        </h2>
