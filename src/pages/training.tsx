...
const ideas = [
    { id: 1, title: 'React', desc: 'Description', period: '2 Months', trainer: 'Shivam', status: 'Completed' },
    { id: 2, title: 'Excel', desc: 'Description', period: '1 Month', trainer: 'Gagan', status: 'Pending' },
    // More people...
]
    ...
    return (
        <div className=' w-full rounded px-2'>
            ...
            <div className=' rounded-lg border border-gray-300 bg-white'>
                <div className="px-4 sm:px-2 lg:px-2 mt-4 mb-2">
