...
const user_attendance = [
    { id: 1, name: 'Shivam', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', excess: 'excess', reason: 'Rain' },
    { id: 1, name: 'Gagan', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', excess: 'excess', reason: 'Rain' },
    { id: 1, name: 'Neeru', date: '04-07-2023', day: '1', in: '9:30 AM', out: '6:30 PM', status: 'Pending', shortfall: '0:00', excess: 'excess', reason: 'Rain' },
    // More people...
]


export default function CurrentInOut() {
