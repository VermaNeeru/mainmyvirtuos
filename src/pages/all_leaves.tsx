                    ...
                    >
                        <li className=" group relative min-w-0 flex-1 overflow-hidden bg-white px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                            <a
                                ...
                                role="tablist"
                            >
                                <p className="font-normal lg:text-base text-xs"> Pending</p>
                            </a>
                        </li>
                        <li className=" group relative min-w-0 flex-1 overflow-hidden bg-white px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                            <a
                                ...
                                role="tablist"
                            >
                                <p className="font-normal lg:text-base text-xs"> Approved</p>
                            </a>
                        </li>
                        <li className=" group relative min-w-0 flex-1 overflow-hidden bg-white px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                            <a
                                ...
                                role="tablist"
                            >
                                <p className="font-normal lg:text-base text-xs"> Rejected</p>
                            </a>
                        </li>
                        <li className=" group relative min-w-0 flex-1 overflow-hidden bg-white px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                            <a
                                ...
                                role="tablist"
                            >
                                <p className="font-normal lg:text-base text-xs"> Cancelled</p>
                            </a>
                        </li>
                    ...
                    <div className=" py-3 px-4 flex-auto">
                                    ...
                                    <div className=" mb-4 px-4 py-4">
                                        <form>
                                            <div className="space-y-2">
                                                <div className="pb-4">
                                                    <div className="mt-2 grid grid-cols-1 gap-x-6 lg:gap-y-8 gap-y-1 lg:grid-cols-2">
                                                    ...
                                                    <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-1">
                                                        <div className="sm:col-span-1">
                                                            <div className=" grid lg:grid-cols-2 grid-cols-1">
                                                                <div className="lg:w-96 w-full mt-2 lg:flex rounded-md shadow-sm">
                                                                    <div className="relative flex flex-grow items-stretch focus-within:z-10">
                                                                        <select
                                                                            id="location"
                                                                            name="location"
                                                                    ...
                                                                    <button onClick={() => setshowUpdateMessage(true)}
                                                                        type="button"
                                                                        className="lg:ml-10 relative   bg-indigo-600  text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 inline-flex gap-x-1.5 px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-gray-300"
                                                                    >
                                                                        Update Status
                                                                    </button>
                                                                </div>
                                                                        ...
                                                                        >
                                                                            <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                                                <div className="py-1">
                                                                                    ...
                                                                                    <Menu.Item>
                                                                                        <a onClick={() => setChangeLeaveStatus(true)} className="bg-gray-100 text-gray-600 block px-4 py-2 text-sm">Change Leave Status</a>
                                                                                    </Menu.Item>
                        ...
                        <Transition.Root show={changeleavestatus} as={Fragment}>
                            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setChangeLeaveStatus}>
                                ...
                                <div className="fixed inset-0 z-10 overflow-y-auto">
                                    <div className="flex min-h-full items-end justify-center lg:p-4 -mt-24 lg:mt-0 text-center sm:items-center sm:p-0">
                                        <Transition.Child
                                            as={Fragment}
                                            enter="ease-out duration-300"
                                            enterFrom="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                    ...
                                                    <div className="pb-4">
                                                            ...
                                                            <div className="sm:col-span-2">
                                                                <div className="mt-1">
                                                                    <form>
                                                                        <div className="space-y-2">
                                                                            <div className="lg:pb-4">
                                                                                <div className="mt-2 grid grid-cols-1 gap-x-6 lg:gap-y-8 gap-y-2 lg:grid-cols-6">
                                                        ...
                                                        <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-1">
                                                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                                <button
                                                                    type="submit"
                                                                    className="lg:ml-2 rounded-md lg:w-52 w-full bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                                                >
                                                                    Change Leave Status
                                                                </button>
                                                                <button
