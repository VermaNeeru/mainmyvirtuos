...
const user_attendance = [
    { id: 1, name: 'Neeru', ldate: '04-07-2023', day: 'Monday', intime: '11:00 am', },
    { id: 2, name: 'Shivam', ldate: '04-07-2023', day: 'Monday', intime: '11:00 am', },
    { id: 3, name: 'Gagan', ldate: '04-07-2023', day: 'Monday', intime: '11:00 am', },
    // More people...
]
                ...
                <div className="flex flex-wrap items-center">
                    <div className="relative w-full max-w-full flex-grow flex-1">
                        <h2 className="text-blueGray-700 text-xl font-semibold">
                            Current Month - Late Arrival Report
                        </h2>
