...
const accounts_travel = [
    { id: 1, itype: 'Workoo', issuefor: 'HR', desc: 'While Filling the timesheet, it does not autofill the user name. We have to manually select for every entry.', idate: '2021-10-19', status: 'Pending' },
    { id: 2, itype: 'Workoo', issuefor: 'HR', desc: 'While Filling the timesheet, it does not autofill the user name. We have to manually select for every entry.', idate: '2021-10-19', status: 'Resolved' },
    { id: 3, itype: 'Workoo', issuefor: 'HR', desc: 'While Filling the timesheet, it does not autofill the user name. We have to manually select for every entry.', idate: '2021-10-19', status: 'Resolved' },
    // More people...
]
