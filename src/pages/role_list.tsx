...
export default function RoleList() {
    ...
    }, [roleId,getQueryById,executeQuery]);
    ...
    return (
        <div className=' w-full rounded px-2'>
            ...
            {showSuccessMessage && (
                ...
                <Alert message="Role Added Successfully!" alertState={false} onAlertStateChange={function (newState: boolean): void {
                    throw new Error('Function not implemented.');
                } } />
            )}
            {showErrorMessage && (
            ...
            {showDeletedMessage && (
                <Alert message="Role Deleted Successfully!" alertState={false} onAlertStateChange={function (newState: boolean): void {
                    throw new Error('Function not implemented.');
                } } />
            )}
