...
const ideas = [
    { id: 1, cname: 'Unit Testing', cstatus: 'Active' },
    { id: 1, cname: 'The Fundamentals Of Digital Marketing', cstatus: 'Active' },
    { id: 1, cname: 'Selenium', cstatus: 'Active' },
    // More people...
]
...
export default function Certifications() {
    ...
    }, [certificationId,getQueryById,executeQuery]);
    ...
    return (
        <div className=' w-full rounded px-2'>
            ...
            {showSuccessMessage && (
                ...
                <Alert message="Certification Added Successfully!" alertState={false} onAlertStateChange={function (newState: boolean): void {
                    throw new Error('Function not implemented.');
                } } />
            )}
            {showErrorMessage && (
            ...
            {showDeletedMessage && (
                <Alert message="Certification Deleted Successfully!" alertState={false} onAlertStateChange={function (newState: boolean): void {
                    throw new Error('Function not implemented.');
                } } />
            )}
                                                            ...
                                                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full w-80 sm:max-w-lg sm:p-6">
                                                                <div className="space-y-2">
                                                                    <div className="border-b border-gray-900/10 pb-4">
                                                                        <h2 className="text-lg font-semibold leading-7 text-gray-900">Add Certification</h2>
